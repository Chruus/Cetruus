public class TetrominoZ extends Tetromino{
    ...
    public TetrominoZ(int row_, int col_, Grid grid_, int rotation_) {
    ...
    public TetrominoZ(int row_, int col_, Grid grid_) {
        super(row_, col_, grid_);
        color clr = color(255, 0, 0);
        blocks[0] = new Block(row, col, clr);
        blocks[1] = new Block(row - 1, col, clr);
    ...
    public void displayGhost() {
        Tetromino ghost = new TetrominoZ(row, col, grid, rotation);
    ...
    public TetrominoZ clone() {
        return new TetrominoZ(row, col, grid);
    }
}