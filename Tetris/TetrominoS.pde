public class TetrominoS extends Tetromino{
    ...
    public TetrominoS(int row_, int col_, int scale_, Grid grid_, int rotation_) {
    ...
    public TetrominoS(int row_, int col_, int scale_, Grid grid_) {
        super(row_, col_, scale_, grid_);
        color clr = color(25, 240, 25);
        blocks[0] = new Block(row, col, scale, clr);
        blocks[1] = new Block(row - 1, col, scale, clr);
    ...
    public TetrominoS(int scale_, Grid grid_) {
    ...
    public void displayGhost() {
        Tetromino ghost = new TetrominoS(row, col, scale, grid, rotation);
    ...
    public TetrominoS clone() {
        return new TetrominoS(row, col, scale, grid);
    }
}