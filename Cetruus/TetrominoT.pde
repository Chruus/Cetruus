public class TetrominoT extends Tetromino{
    ...
    public TetrominoT(int row_, int col_, Grid grid_, int rotation_) {
    ...
    public TetrominoT(int row_, int col_, Grid grid_) {
        super(row_, col_, grid_);
        color clr = color(125, 0, 255);
        blocks[0] = new Block(row, col, clr);
        blocks[1] = new Block(row - 1, col, clr);
    ...
    public void displayGhost() {
        Tetromino ghost = new TetrominoT(row, col, grid, rotation);
    ...
    public TetrominoT clone() {
        return new TetrominoT(row, col, grid);
    }
}