public class GUISettings extends GUI{
    ...
    public GUISettings(int scale_, color textColor, color backgroundColor) {
        ...
        toMisc = new Button("DAS", textColor,(int)(6.25 * scale),(int)(1.5 * scale),(int)(3.5 * scale), 2 * scale, backgroundColor);
        toKeyBindings = new Button("Key Binds", textColor,(int)(10.75 * scale),(int)(1.5 * scale),(int)(5.5 * scale), 2 * scale, backgroundColor);
    }
